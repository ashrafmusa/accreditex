    ...
    return (
        <div className="bg-brand-surface dark:bg-dark-brand-surface p-6 rounded-lg shadow-sm border border-gray-200 dark:border-dark-brand-border">
            <div className="flex justify-between items-center mb-4">
                ...
                {canEdit && <button onClick={() => { setEditingCompetency(null); setIsModalOpen(true); }} className="flex items-center justify-center text-sm bg-brand-primary text-white px-2 sm:px-3 py-1.5 rounded-md hover:bg-indigo-700" title={t('addCompetency')}>
