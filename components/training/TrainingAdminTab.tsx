    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row gap-2 justify-end">
        <button
          ...
          className="bg-white dark:bg-slate-700 text-brand-text-primary dark:text-dark-brand-text-primary border border-slate-300 dark:border-slate-600 px-4 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-600 flex items-center justify-center font-semibold shadow-sm"
        >
          {t("assignTraining")}
        </button>
        <button
        ...
        <div className="overflow-x-auto">
          ...
          {trainingPrograms.length === 0 && (
            <EmptyState
              ...
              message="Create a new training program to get started."
            />
          )}
        </div>
      </div>
